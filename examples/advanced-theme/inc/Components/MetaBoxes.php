...
class MetaBoxes implements ComponentInterface {
	...
	private function save_portfolio_meta( $post_id ): void {
		...
		$fields = array( 'portfolio_client', 'portfolio_url', 'portfolio_year', 'portfolio_role' );
	...
	private function save_testimonial_meta( $post_id ): void {
		...
		$fields = array( 'testimonial_author', 'testimonial_position', 'testimonial_company', 'testimonial_rating' );
	...
	private function save_case_study_meta( $post_id ): void {
		...
		$text_fields     = array( 'case_study_client', 'case_study_duration' );
		$textarea_fields = array( 'case_study_challenge', 'case_study_solution', 'case_study_results' );
