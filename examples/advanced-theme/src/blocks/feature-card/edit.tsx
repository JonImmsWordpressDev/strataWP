...
export default function Edit({ attributes, setAttributes }: EditProps) {
  ...
  return (
    <>
      <InspectorControls>
        <PanelBody title={__('Icon Settings', 'strata-advanced')}>
          <TextControl
            label={__('Icon (emoji or text)', 'strata-advanced')}
      ...
      <div {...blockProps}>
        ...
        <RichText
          ...
          placeholder={__('Feature title...', 'strata-advanced')}
        />
        <RichText
          tagName="p"
          ...
          placeholder={__('Feature description...', 'strata-advanced')}
        />
      </div>
    </>
  )
