...
function strata_basic_vite_dev_server(): void {
	...
	// phpcs:disable WordPress.WP.EnqueuedResources.NonEnqueuedScript -- Vite HMR requires type="module" scripts pointing at the dev-server URL; wp_enqueue_script() cannot express this pattern.
	printf(
