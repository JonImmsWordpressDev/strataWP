...
function strata_basic_vite_dev_server(): void {
	...
	// phpcs:disable WordPress.WP.EnqueuedResources.NonEnqueuedScript -- Vite HMR client must be injected as a raw module script; wp_enqueue_script() does not support type="module" entry points for HMR.
	printf(
